...
$ExpectedSha256 = "777bc6d7ed93a7f46fefc723ec72e7ef7f45145380045f1653c48fe48ff61082"
$Version = "1.3.25.6.8.6.5-online-1"
...
"@
    ...
    if (
        ...
        [regex]::Escape("Sala de voz da Squad")
    ) {
        throw (
            "Verificacao funcional falhou: " +
            "Sala de voz nao apareceu no index.html instalado."
        )
    }
    ...
    if (
        ...
        throw (
            "Verificacao funcional falhou: " +
            "voice-join nao apareceu no renderer.js instalado."
        )
    }
